...
На бесплатном Web Service Render может останавливать инстанс после ~15 мин без HTTP-трафика.  
Long Poll тоже остановится — сообщения не придут, пока сервис не проснётся.  
**Решение:** план Starter или внешний ping на `/health` каждые 10 мин (cron-job.org).
